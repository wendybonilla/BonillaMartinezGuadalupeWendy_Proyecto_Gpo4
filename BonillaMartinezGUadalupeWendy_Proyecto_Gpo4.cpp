...
// Window dimensions
const GLuint WIDTH = 1720, HEIGHT = 980;
...
int main()
{
	...
	Model Casa((char*)"Models/Objetos/yacasa.obj");
	...
	//textura 1
	// Diffuse map
	image = stbi_load("Models/Objetos/Piso.tga", &textureWidth, &textureHeight, &nrChannels, 0);
	...
	//textura 2
	// Diffuse map
	image = stbi_load("Models/Objetos/Fachada2.tga", &textureWidth, &textureHeight, &nrChannels, 0);
	...
	//textura 3
	// Diffuse map
	image = stbi_load("Models/Objetos/techo.tga", &textureWidth, &textureHeight, &nrChannels, 0);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		Casa.Draw(lightingShader);(lightingShader);
